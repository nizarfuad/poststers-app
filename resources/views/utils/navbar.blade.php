<nav class="lg:fixedlg:w-full lg:z-11  bg-gray-900" x-data="{ isOpen: false }">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-11 flex items-baseline space-x-4">
                        ...
                        <div>
                            <a href="/home"
                                class="{{ $title === 'home' ? 'link-underline-active text-white' : 'link link-underline link-underline-black' }} text-sm font-medium  mr-1.5 text-gray-400 mx-1.5"
                                aria-current="page">home</a>
                        </div>
                        <div>
                            <a href="#"
                                class=" {{ $title === 'blog' ? 'link-underline-active text-white' : 'link link-underline link-underline-black' }} text-sm font-medium text-gray-400 mx-1.5">blog</a>
                        </div>
                        <div>
                            <a href="/posts"
                                class=" {{ $title === 'posts' ? 'link-underline-active text-white' : 'link link-underline link-underline-black' }} text-sm font-medium text-gray-400 mx-1.5">posts</a>
                        </div>
                    </div>
                </div>
            </div>
